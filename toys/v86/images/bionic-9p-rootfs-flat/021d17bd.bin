...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/i386-linux-gnu/perl/5.26',
    ...
    exe_ext => '',
    inc_version_list => '5.26.0 5.26.0/i686-linux-gnu-thread-multi-64int',
    intsize => '4',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/i386-linux-gnu/perl/5.26.1',
